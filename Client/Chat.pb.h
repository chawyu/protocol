...
@class SendMessageRequest200;
@class SendMessageRequest200Builder;
...
#define SendMessageRequest200_access_token @"accessToken"
#define SendMessageRequest200_from @"pb_from"
#define SendMessageRequest200_to @"to"
#define SendMessageRequest200_text @"text"
#define SendMessageRequest200_topic @"topic"
@interface SendMessageRequest200 : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasAccessToken_:1;
  BOOL hasFrom_:1;
  BOOL hasTo_:1;
...
@interface SendMessageRequest200Builder : PBGeneratedMessageBuilder {
@private
  SendMessageRequest200* resultSendMessageRequest200;
}
