...
static id<PBExtensionField> Ext_test = nil;
...
+ (void) registerAllExtensions:(PBMutableExtensionRegistry*) registry {
  [registry addExtension:Ext_test];
}
@end
...
@property (strong) NSMutableArray<PersonPhoneNumber*> * phoneArray;
@property (strong) PBAppendableArray * testArray;
@end
...
- (NSArray<PersonPhoneNumber*> *)phone {
  return phoneArray;
}
...
- (SInt32)testAtIndex:(NSUInteger)index {
  return [testArray int32AtIndex:index];
}
- (BOOL) isInitialized {
  if (!self.hasName) {
    return NO;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  const NSUInteger testArrayCount = self.testArray.count;
  if (testArrayCount > 0) {
    const SInt32 *values = (const SInt32 *)self.testArray.data;
    [output writeRawVarint32:42];
    [output writeRawVarint32:testMemoizedSerializedSize];
    for (NSUInteger i = 0; i < testArrayCount; ++i) {
...
- (SInt32) serializedSize {
  ...
  }];
  {
    ...
    const NSUInteger count = self.testArray.count;
    const SInt32 *values = (const SInt32 *)self.testArray.data;
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
  ...
  NSMutableArray * testArrayArray = [NSMutableArray new];
  NSUInteger testArrayCount=self.testArray.count;
  for(int i=0;i<testArrayCount;i++){
    [testArrayArray addObject: @([self.testArray int32AtIndex:i])];
  }
  [dictionary setObject: testArrayArray forKey: @"test"];
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      [self isEqualExtensionsInOther:otherMessage from:10 to:536870912] &&
...
- (NSUInteger) hash {
  ...
  [self.testArray enumerateObjectsUsingBlock:^(NSNumber *obj, NSUInteger idx, BOOL *stop) {
    hashCode = hashCode * 31 + [obj longValue];
  }];
  hashCode = hashCode * 31 + [self hashExtensionsFrom:10 to:536870912];
...
- (PersonBuilder*) mergeFrom:(Person*) other {
  ...
  if (other.testArray.count > 0) {
    if (resultPerson.testArray == nil) {
      resultPerson.testArray = [other.testArray copy];
    } else {
      [resultPerson.testArray appendArray:other.testArray];
    }
  }
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 42: {
        ...
        if (resultPerson.testArray == nil) {
          resultPerson.testArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeInt32];
        }
        while (input.bytesUntilLimit > 0) {
          [resultPerson.testArray addInt32:[input readInt32]];
        }
...
- (PBAppendableArray *)test {
  return resultPerson.testArray;
}
- (SInt32)testAtIndex:(NSUInteger)index {
  return [resultPerson testAtIndex:index];
}
- (PersonBuilder *)addTest:(SInt32)value {
  if (resultPerson.testArray == nil) {
    resultPerson.testArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeInt32];
  }
  [resultPerson.testArray addInt32:value];
  return self;
}
- (PersonBuilder *)setTestArray:(NSArray *)array {
  resultPerson.testArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeInt32];
  return self;
}
- (PersonBuilder *)setTestValues:(const SInt32 *)values count:(NSUInteger)count {
  resultPerson.testArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeInt32];
  return self;
}
- (PersonBuilder *)clearTest {
  resultPerson.testArray = nil;
  return self;
}
@end
...
static Ext* defaultExtInstance = nil;
+ (void) initialize {
  if (self == [Ext class]) {
    defaultExtInstance = [[Ext alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultExtInstance;
}
- (instancetype) defaultInstance {
  return defaultExtInstance;
}
...
+ (Ext*) parseFromData:(NSData*) data {
  return (Ext*)[[[Ext builder] mergeFromData:data] build];
}
+ (Ext*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (Ext*)[[[Ext builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (Ext*) parseFromInputStream:(NSInputStream*) input {
  return (Ext*)[[[Ext builder] mergeFromInputStream:input] build];
}
+ (Ext*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (Ext*)[[[Ext builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (Ext*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (Ext*)[[[Ext builder] mergeFromCodedInputStream:input] build];
}
+ (Ext*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (Ext*)[[[Ext builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (ExtBuilder*) builder {
  return [[ExtBuilder alloc] init];
}
+ (ExtBuilder*) builderWithPrototype:(Ext*) prototype {
  return [[Ext builder] mergeFrom:prototype];
}
- (ExtBuilder*) builder {
  return [Ext builder];
}
- (ExtBuilder*) toBuilder {
  return [Ext builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[Ext class]]) {
    return NO;
  }
  Ext *otherMessage = other;
  return
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
...
@interface ExtBuilder()
@property (strong) Ext* resultExt;
@end

@implementation ExtBuilder
@synthesize resultExt;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultExt = [[Ext alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (ExtBuilder*) clone {
  return [Ext builderWithPrototype:resultExt];
}
- (Ext*) defaultInstance {
  return [Ext defaultInstance];
}
- (Ext*) build {
  [self checkInitialized];
  return [self buildPartial];
...
- (Ext*) buildPartial {
  Ext* returnMe = resultExt;
  self.resultExt = nil;
  return returnMe;
}
- (ExtBuilder*) mergeFrom:(Ext*) other {
  if (other == [Ext defaultInstance]) {
    return self;
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
